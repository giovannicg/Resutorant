 ...
 * @returns
 */
export declare function upgradePackageDefinitions(currentDependencies: Index<VersionSpec>, options: Options): Promise<[Index<VersionSpec>, Index<VersionSpec>, Index<Index<VersionSpec>>?]>;
